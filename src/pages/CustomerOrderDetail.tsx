...
import { ArrowLeft, Loader2, MapPin, Package, Truck, CheckCircle2, Clock, XCircle } from 'lucide-react';
...
export function CustomerOrderDetail({ orderId, onBack, onMessageVendor }: Props) {
    ...
    <div className="pb-24">
      <div className="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-slate-100 px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="font-bold text-slate-900 text-sm truncate">Swivi kòmand</h1>
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {order.status === 'cancelled' ? (
          ...
          <div className="bg-white rounded-xl border border-slate-100 p-4 space-y-3">
            <p className="text-xs font-semibold text-slate-500">Pwogrè</p>
            {steps.map((step, i) => {
